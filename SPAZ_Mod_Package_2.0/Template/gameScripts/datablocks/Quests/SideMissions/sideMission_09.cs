...
///////////////////////////////////////////////////////////
// SIDE MISSION 09 DIALOG
///////////////////////////////////////////////////////////

new ScriptGroup (Dialog_sideMission_09_A : dialogBox_base) 
{
...
new ScriptGroup (Dialog_sideMission_09_BossIntro : dialogBox_base) 
{
   character[0] = "MS_TURBODEF";
   text[0]      = "Now you destroy TURBO DEFENDER 9000-EX's children?  Why is your unit so cruel?  Prepare to be re-formatted!  You shall experience extreme discomfort.";
};

new ScriptGroup (Dialog_sideMission_09_B : dialogBox_base) 
{
   character[0] = "MS_TURBODEF";
...
function AIShipClass::SM_09_nearPlayerCheck(%this)
{
   %position = GetCurrentInstance().GetRefObjectPosition("REF_Player");
   if (t2dVectorDistance(%position, %this.position) < 1300)
   {
      %currentModule = %this.GetCommandModule();
      %currentModule.SetTactic_Script("TP_Destruct", "TP_DestructOn"); 
      %currentModule.SetTactic_Script("TP_Stance", "TP_Passive"); 
      return;
   }
   
   %this.sceneSchedule(350, "SM_09_nearPlayerCheck");
}
...
new ScriptGroup(Quest_SideMission_09 : QuestBase_SideMission)
{
